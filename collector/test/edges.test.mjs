...
const ARGS = {
  ...
  '/api/vehicle/movement': 'plate=NOPLATE', '/api/vehicle/safety': 'plate=NOPLATE',
  '/api/vehicle/compliance': 'plate=NOPLATE', '/api/vehicle/trips': 'plate=NOPLATE',
  '/api/vehicle/mix': 'plate=NOPLATE', '/api/vehicle/hours': 'plate=NOPLATE',
