...
export const ROUTES = [
  ...
  'corridors', 'finance', 'receipts', 'identity', 'settlement', 'settlement/cash', 'settlement/receivables',
  ...
  'causes', 'forecast', 'trips', 'provenance', 'retention', 'playbook', 'capacity', 'optimise', 'revenue',
