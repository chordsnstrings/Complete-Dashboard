...
export const SETTING_DEFS = [
  ...
  { key: 'UBER_WEB_COOKIE', group: 'Uber', label: 'Supplier web session cookie', secret: true, hint: 'Expires — re-paste from a logged-in fleethub.uber.com session' },
  ...
  { key: 'UBER_WEB_COOKIE_EGARI', group: 'Uber', label: 'Supplier web session cookie — Egari', secret: true, hint: 'Expires — re-paste from a logged-in fleethub.uber.com session for the Egari org' },
